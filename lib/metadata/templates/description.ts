...
const DEFAULT_TEMPLATE = 'Welcome to kingscan. You can check all transaction, block, balance. Feel free to use. We support APIs, and ecosystem tools to discover our chain.';
